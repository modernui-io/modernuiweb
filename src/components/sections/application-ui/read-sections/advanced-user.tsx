        ...
        <div className="mb-4 grid gap-4 px-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12">
          <div className="sm:col-span-2">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="mb-2 flex items-center text-xl font-bold leading-none sm:text-2xl">
                  Helene Engels
                  <Badge className="ml-3 text-base uppercase">Pro</Badge>
                </h2>
                <Badge color="info" className="w-fit px-3">
                  <HiEye className="mb-0.5 mr-1 size-3" />
                  Moderator
                </Badge>
              </div>
            </div>
            <dl className="mt-4">
              ...
              <dt className="mb-2 font-semibold leading-none">Job Title</dt>
          ...
          <dl>
            <dt className="mb-2 font-semibold leading-none">Email Adress</dt>
            <dd className="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">
              helene@company.com
            </dd>
            <dt className="mb-2 font-semibold leading-none">Home Adress</dt>
            <dd className="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">
              92 Miles Drive, Newark, NJ 07103, California, United States of
              America
            </dd>
            <dt className="mb-2 font-semibold leading-none">Phone Number</dt>
            <dd className="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">
