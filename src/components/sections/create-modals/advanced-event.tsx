...
import { HiClock, HiLocationMarker, HiPlus } from "react-icons/hi";
import { z } from "zod";
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center space-x-4">
              ...
              <DialogClose asChild>
                <Button
                  variant={"outline"}
                  className="text-sm text-gray-500 hover:text-gray-900 dark:bg-gray-700 dark:enabled:hover:bg-gray-600"
                >
                  Discard
                </Button>
              </DialogClose>
