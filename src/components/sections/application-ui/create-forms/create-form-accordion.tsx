...
const formSchema = z.object({
  ...
  offerStart: z.date().optional(),
  offerEnd: z.date().optional(),
});

export function CreateFormAccordion() {
                  ...
                  <div className="border-muted-foreground/10  px-1 pt-4 dark:border-muted sm:pt-5">
                    <div className="grid gap-4 md:grid-cols-2 md:gap-6">
                      <div className="space-y-4 sm:space-y-6">
                        ...
                        <div className="flex items-center">
                          <Checkbox className="size-4 rounded border-white/70 bg-muted-foreground/30 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-muted-foreground/30 dark:bg-muted dark:ring-offset-muted-foreground/20 dark:focus:ring-primary-600" />
                          <Label className="ml-2 text-sm text-muted-foreground">
