      ...
      <DrawerContent className="w-fit">
        <ScrollArea>
          ...
          <div className="bottom-0 left-0 flex w-full justify-start space-x-4 p-4 dark:bg-muted-foreground/20">
            ...
            <DrawerClose asChild>
              <Button className="inline-flex w-full items-center justify-center rounded-lg border border-muted-foreground/10 bg-white px-5 py-2.5 text-sm font-medium text-white hover:bg-muted-foreground/30 focus:z-10 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:border-muted-foreground/40 dark:bg-muted dark:hover:bg-muted-foreground/30 dark:hover:text-primary-foreground dark:focus:ring-muted-foreground/30">
