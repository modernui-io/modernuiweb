        ...
        <div className="mt-8 rounded-lg bg-gray-50 p-4 dark:bg-gray-800 sm:p-12 lg:mt-16">
          <div className="grid grid-cols-1 gap-8 sm:gap-12 lg:grid-cols-2">
            <div className="flex flex-col items-start gap-4 sm:flex-row sm:gap-5">
              <div className="flex size-16 shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 lg:size-24">
                <svg
                  aria-hidden="true"
                  className="size-10 text-primary-600 dark:text-primary-500 lg:size-12"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
              ...
              <div>
                ...
                <Text className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400 sm:text-lg">
