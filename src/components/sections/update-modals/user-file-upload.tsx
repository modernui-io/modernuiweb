            ...
            <div className="mb-4 grid gap-4 sm:grid-cols-2">
              ...
              <div>
                      ...
                      <TooltipTrigger>
                        <button className="ml-1">
                          <svg
                            ...
                            className="size-4 cursor-pointer text-gray-400 hover:text-gray-900 dark:text-gray-500 dark:hover:text-white"
                          >
                            <path
                              fillRule="evenodd"
                ...
                <Select name="user-permissions">
                  ...
                  <SelectContent>
                    <SelectItem value="OP">Operational</SelectItem>
                    <SelectItem value="NOP">Non Operational</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div>
                ...
                <div className="w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
                  ...
                  <div className="rounded-b-lg bg-white px-4 py-2 dark:bg-gray-800 dark:[&>textarea]:bg-gray-800">
                    <Textarea
                      ...
                      required
                      rows={8}
                      className="border-0 bg-white px-0 text-sm focus:ring-0 dark:border-gray-500"
                    >
