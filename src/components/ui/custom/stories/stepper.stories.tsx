...
import StepperClickableSteps from "~/components/ui/custom/stepper/examples/stepper-clickable-steps";
import StepperCustomIcons from "~/components/ui/custom/stepper/examples/stepper-custom-icons";
import StepperCustomStyles from "~/components/ui/custom/stepper/examples/stepper-custom-styles";
import StepperDemo from "~/components/ui/custom/stepper/examples/stepper-demo";
import StepperFooterInside from "~/components/ui/custom/stepper/examples/stepper-footer-inside";
import StepperForm from "~/components/ui/custom/stepper/examples/stepper-form";
import StepperOptionalSteps from "~/components/ui/custom/stepper/examples/stepper-optional-steps";
import StepperOrientation from "~/components/ui/custom/stepper/examples/stepper-orientation";
import StepperScrollTracking from "~/components/ui/custom/stepper/examples/stepper-scroll-tracking";
import StepperSizes from "~/components/ui/custom/stepper/examples/stepper-sizes";
import StepperState from "~/components/ui/custom/stepper/examples/stepper-state";
import StepperVariants from "~/components/ui/custom/stepper/examples/stepper-variants";

// https://shadcn-stepper.vercel.app/
// https://github.com/damianricobelli/shadcn-stepper/tree/main

/**
 * A Stepper component with clickable steps.
 */
...
/**
 * All Variants of the Stepper component.
 */
