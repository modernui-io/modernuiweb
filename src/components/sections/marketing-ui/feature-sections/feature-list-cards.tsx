    ...
    <MuiLayout.Section>
      <MuiLayout.Container className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-8 md:space-y-0 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
          <Card>
            <CardHeader>
              <div className="flex size-10 items-center justify-center rounded bg-primary-100 dark:bg-primary-900 lg:size-12">
                <svg
                  className="size-5 text-primary-600 dark:text-primary-300 lg:size-6"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <Heading level={3} className="text-xl font-bold dark:text-white">
                Marketing
              </Heading>
            </CardHeader>
            <CardContent>
