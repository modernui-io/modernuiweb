            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <svg
                    aria-hidden
                    className="absolute left-2 size-5 text-gray-500 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
              ...
              <div className="items-center sm:flex sm:space-x-4">
                ...
                <Button
                  variant={"outline"}
                  className="mr-3 inline-flex border-gray-200 bg-white text-xs text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:outline-none focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                >
                  <svg
                    aria-hidden
                ...
                <div className="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                  <div className="w-full">
                    ...
                    <Select name="reminder-type">
                      ...
                      <SelectContent>
                        <SelectItem value="NT">Notification</SelectItem>
                        <SelectItem value="AL">Alarm</SelectItem>
                        <SelectItem value="EM">Email</SelectItem>
                        <SelectItem value="SM">SMS</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="w-full">
                  ...
                  <div className="w-full">
                    ...
                    <Select name="reminder-length-type">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="WE">Weeks</SelectItem>
