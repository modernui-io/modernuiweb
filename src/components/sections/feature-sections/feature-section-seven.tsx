  ...
  return (
    <MuiLayout.Section className="bg-white dark:bg-gray-900">
      <MuiLayout.Container className="mx-auto max-w-screen-xl px-4 py-8 text-center sm:py-16 lg:px-6">
        ...
        <Text className="text-gray-500 dark:text-gray-400 sm:text-xl lg:px-48">
        ...
        <div className="my-8 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:mt-16">
          <div>
            <div className="mb-6 inline-flex size-24 items-center justify-center rounded-lg bg-primary-100 dark:bg-primary-900">
              <svg
                className="mx-auto size-16 text-primary-600 dark:text-primary-500"
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <div>
            <div className="mb-6 inline-flex size-24 items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900">
              <svg
                className="mx-auto size-16 text-purple-600 dark:text-purple-500"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
