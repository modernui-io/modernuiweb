    ...
    <MuiLayout.Section>
      <MuiLayout.Container className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-8 md:space-y-0 lg:grid-cols-3 xl:gap-12">
          <div>
            <div className="mb-4 flex size-10 items-center justify-center rounded bg-purple-100 dark:bg-purple-900 lg:size-16">
              <svg
                className="size-5 text-primary-600 dark:text-primary-300 lg:size-8"
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <div>
            <div className="mb-4 flex size-10 items-center justify-center rounded bg-purple-100 dark:bg-purple-900 lg:size-16">
              <svg
                className="size-5 text-purple-600 dark:text-purple-300 lg:size-8"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <ul className="my-6 space-y-4 lg:mb-0">
              <li className="flex space-x-2.5">
                <svg
                  className="size-5 shrink-0 text-purple-600 dark:text-purple-500"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div>
            <div className="mb-4 flex size-10 items-center justify-center rounded bg-teal-100 dark:bg-teal-900 lg:size-16">
              <svg
                className="size-5 text-teal-600 dark:text-teal-300 lg:size-8"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <ul className="my-6 space-y-4 lg:mb-0">
              <li className="flex space-x-2.5">
                <svg
                  className="size-5 shrink-0 text-teal-500 dark:text-teal-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
