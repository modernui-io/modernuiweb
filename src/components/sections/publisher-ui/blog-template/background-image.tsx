...
const ArticlesData: Article[] = [
  {
    ...
    description2: "Over the past year, Volosoft has undergone many changes.",
...
const ArticleCardVertical = (article: Article) => {
  const { imgSrc, imgAlt, title, description2, readTime, link } = article;
  return (
    <article className="mb-8 flex">
      <Link href={link} passHref className="shrink-0">
        <Image
          src={imgSrc}
          className="mr-4 size-24 max-w-full rounded-lg object-cover align-middle"
          alt={imgAlt}
        />
      </Link>
      <div className="flex flex-col justify-center">
        <Text className="mb-2 text-lg font-bold leading-tight">
    ...
    <Popover>
      <PopoverTrigger asChild>
        <div
          ...
          className={`inline-flex items-center rounded-lg bg-background p-2 text-center text-sm font-medium text-muted-foreground hover:bg-primary-200 ${className} hover:cursor-pointer`}
        >
...
const CommentSection = () => {
  ...
  return (
    <div className="bg-background py-8 pt-0 antialiased lg:py-16">
  ...
  return (
    <div>
      ...
      <ol type="1" className="ml-[28px] list-decimal">
        <li className="mb-6 md:text-lg md:leading-8">
      ...
      <Text level="baseTall" className="mb-6 md:text-lg md:leading-8">
  ...
  return (
    <div className="bg-background">
      <main className="mb-16 bg-background antialiased lg:pb-24">
        <header
          className="relative mx-auto h-[460px] max-w-[1391px] xl:h-[537px]"
        ...
        >
          ...
          <div className="absolute left-1/2 top-20 mx-auto w-full max-w-screen-xl -translate-x-1/2 px-4 xl:top-1/2 xl:-translate-y-1/2 xl:px-0">
            ...
            <Heading
              level={1}
              className="mb-4 max-w-4xl text-wrap font-extrabold leading-10 tracking-normal text-white"
            >
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div
                            ...
                            className="inline-flex items-center rounded-lg bg-background p-2 text-center text-sm font-medium text-muted-foreground hover:cursor-pointer hover:bg-primary-200 focus:outline-none"
                          >
                            {icon}
                          </div>
                        </TooltipTrigger>
