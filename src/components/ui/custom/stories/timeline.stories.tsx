...
/**
 * Labels Varient of the timeline.
 */
export const LabelsVariant: Story = {
  render: (args) => {
    return (
...
/**
 * Alternate Varient of the timeline.
 */
