...
const LitecoinSVG = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_3843_5829)">
      <path
...
const DashSVG = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_3843_5834)">
      <path
...
const formSchema = z.object({
  ...
  noOfInstallments: z.string(),
  occupation: z.string(),
  monthlyPayment: z.string(),
});

export const PaymentFormTabs = () => {
  const paymentLogos = [
    {
      src: Paypal,
      darkSrc: PaypalDark,
  ...
  const paymentMethodsButton = [
    ...
    },
    {
      ...
      icon: <DogecoinSVG />,
      label: "Pay with Dogecoin",
    },
  ];

  const banks = [
    { id: 1, name: "mordernUiWeb Bank", monthlyPayment: "$49/month" },
    { id: 2, name: "JPMorgan Bank", monthlyPayment: "$39/month" },
    { id: 3, name: "Wells Fargo Bank", monthlyPayment: "$59/month" },
  ];
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <Tabs defaultValue="creditCard">
              <TabsList className="grid w-full grid-cols-4">
                ...
                <TabsTrigger value="Monthlyfees">Monthly fees</TabsTrigger>
              ...
              <TabsContent value="creditCard">
                                      ...
                                      <PopoverTrigger asChild>
                                        <FormControl>
                                          <Button
                                            variant={"outline"}
                                            className={cn(
                                              "w-full bg-primary-50 pl-3 text-left font-normal",
                                              !field.value &&
                ...
                <Text className="mt-4 text-center text-base font-normal text-primary-500  sm:mt-8 lg:text-left">
              ...
              <TabsContent
                className="space-y-4 pt-4 md:space-y-6"
                value="Monthlyfees"
              >
                ...
                <div className="relative overflow-x-auto">
                  <Table className="table w-full text-left text-sm text-primary-500  sm:min-w-full rtl:text-right">
                    <TableHeader className="bg-primary-50 text-xs uppercase text-primary-50 ">
                      <TableRow>
                        <TableHead
                          scope="col"
                        ...
                        <TableHead scope="col" className="rounded-tr-md">
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center">
                              <Input
                                id={`credit-method-radio-${bank.id}`}
                                type="radio"
                                value={bank.id}
                              ...
                              />
                              <Label
                                htmlFor={`credit-method-radio-${bank.id}`}
                                className="ms-2 text-sm font-medium text-primary-900"
                              >
                                {bank.name}
                              </Label>
                          ...
                          <TableCell className="px-6 py-4 font-medium text-primary-900 ">
                            {bank.monthlyPayment}
                          </TableCell>
                          <TableHead className="px-6 py-4">
                            ...
                            >
                              <Eye className="me-2 size-4 shrink-0" />
                ...
                <div className="flex items-start">
                  ...
                  <Label
                    ...
                    className="-mt-0.5 ms-2 text-sm text-primary-500"
                  >
                    I have taken note{" "}
                    <Link
                      href="#"
                    ...
                    >
                      of the information note regarding the processing of
                      personal data
                    </Link>{" "}
                    by JPMorgan Bank
                  </Label>
              ...
              <TabsContent value="crypto">
                <Text className="my-4 text-sm font-medium text-primary-900 ">
                  Select payment option
                </Text>
                <ul className="mb-4 grid w-full gap-4 md:mb-6 md:grid-cols-2">
                  {paymentMethodsButton.map((method) => (
                    <li key={method.id}>
                      <Input
                        type="radio"
                        id={method.id}
                      ...
                      <Label
                        htmlFor={method.id}
                        className="inline-flex w-full cursor-pointer items-center rounded-lg border border-primary-200 bg-background p-4 text-primary-500 peer-checked:border-primary-600 peer-checked:text-primary-600 hover:bg-primary-100 hover:text-primary-600   "
                      >
                        {method.icon}
              ...
              <TabsContent value="paypal" className="py-3">
                <Button className="flex w-full items-center justify-center rounded-lg bg-yellow-300 px-5 py-2.5 text-sm font-medium text-primary-900 hover:bg-yellow-400 focus:outline-none focus:ring-4  focus:ring-yellow-100 ">
                  <PaypalIcon />
                  Pay now with Paypal
                </Button>
              </TabsContent>
