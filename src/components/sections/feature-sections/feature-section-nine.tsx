  ...
  return (
    <MuiLayout.Section>
      <MuiLayout.Container className="mx-auto max-w-screen-xl items-center gap-8 px-4 py-8 sm:py-16 lg:grid lg:grid-cols-2 lg:px-6 xl:gap-16 ">
        <Image alt="" src="" className="mb-4 w-full rounded-lg lg:mb-0" />
        <div className="text-gray-500 dark:text-gray-400 sm:text-lg">
          ...
          <div className="mb-6 border-y border-gray-200 py-8 dark:border-gray-700">
            <div className="flex">
              <div className="mr-4 flex size-8 shrink-0 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900">
                <svg
            ...
            <div className="flex pt-8">
              <div className="mr-4 flex size-8 shrink-0 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900">
                <svg
            ...
            <div className="flex pt-8">
              <div className="mr-4 flex size-8 shrink-0 items-center justify-center rounded-full bg-teal-100 dark:bg-teal-900">
                <svg
